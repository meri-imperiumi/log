...
Compared to the Parasailor it is quite a lot more rigging to get it stable, and a lot more hassle to gybe. But the benefit is that it can be reefed, and it is easier to go from it back to the regular sailing setup. With the gusty conditions it was surprisingly fast. We even out-sailed a 10m catamaran.
